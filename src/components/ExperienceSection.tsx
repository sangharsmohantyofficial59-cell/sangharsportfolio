...
const journey: RouteStop[] = [
  {
    ...
    organization: 'ISERVEU TECHNOLOGIES PVT. LTD.',
    description: 'Owning delivery for NSDL Agency Banking and the TAV2 Prepaid Card product — running daily Agile ceremonies across Tech, Product, QA & Implementation, and piloting AI-assisted spec-driven prototyping.',
  },
  {
    id: '02',
    year: '2023 - 2025',
    title: 'SME - VOICE PROCESS',
    organization: 'CONCENTRIX DAKSH',
    description: 'Handled escalations and process quality as a subject-matter expert, building the structured communication and stakeholder-handling discipline behind current PM work.',
  },
  {
    id: '03',
    year: '2018 - 2021',
    title: 'MANAGEMENT EXECUTIVE - PRODUCTION',
    organization: 'CEAT TYRES',
    description: 'Coordinated production-floor operations and cross-team execution, an early grounding in process ownership and on-ground delivery discipline.',
  },
  {
    id: '04',
    year: '2014 - 2018',
    ...
    description: 'Built a technical foundation spanning mechanical, electronics, and control systems — the engineering base that now informs a structured, systems-first approach to product delivery.',
  },
];
