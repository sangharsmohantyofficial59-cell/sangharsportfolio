        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Sanghars Mohanty</span>, a Project Manager in fintech &amp; banking technology at iServeU Technologies, delivering agency banking and prepaid card products end-to-end. I coordinate Tech, Product, QA &amp; Implementation teams through daily Agile delivery, and run a freelance practice designing AI-assisted, spec-driven workflows and digital brand builds on the side.
            </motion.p>
