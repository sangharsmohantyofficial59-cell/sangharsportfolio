...
const bentoCategories = [
  {
    ...
    items: ['Agile / Scrum', 'Sprint Planning', 'Daily Stand-ups', 'Backlog Management', 'Release Coordination', 'SDLC'],
    description: 'Owning products from requirement gathering to production go-live, running daily Agile ceremonies across Tech, Product, QA & Implementation teams.',
    stat: '7-MONTH GO-LIVE',
    colSpan: 'lg:col-span-7',
  },
  {
    title: 'FINTECH & BANKING DOMAIN',
    badge: 'AGENCY BANKING',
    items: ['AEPS', 'DMT', 'Cashout', 'Account Opening', 'UPI CashPoint', 'UPI CashFlow'],
    description: 'Deep domain grounding in agency banking and prepaid card products, translating regulatory & business requirements into shippable features.',
    stat: '5 CORE PRODUCTS',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'TOOLS & PMO REPORTING',
    badge: 'TRACKING & GOVERNANCE',
    items: ['Jira', 'Zoho Projects', 'RAID Tracking', 'MOM Documentation', 'MS Office', 'Google Sheets'],
    description: 'Maintaining ticket hygiene, release logs, RAID registers, and stakeholder reporting that keeps delivery visible and on schedule.',
    stat: 'PMO REPORTING',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'AI-ASSISTED WORKFLOWS',
    badge: 'SPEC-DRIVEN PROTOTYPING',
    items: ['Claude Projects', 'ChatGPT', 'Google AI Studio', 'Multi-Agent Design', 'Rapid Prototyping'],
    description: 'Piloting AI-assisted, spec-driven workflows — including multi-agent systems that convert requirement docs into structured feature files.',
    stat: 'NEXT-GEN MODULES',
    colSpan: 'lg:col-span-7',
  },
];
